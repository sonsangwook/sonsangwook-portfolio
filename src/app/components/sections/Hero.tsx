...
export function Hero() {
    return (
        <section id="hero" className="relative cursor-none bg-black">
            ...
            <div className="container mx-auto px-4 lg:px-8 max-w-screen-xl relative z-30 flex flex-col justify-start pt-32 pb-40 md:pt-40 md:pb-[400px]">
                <div className="space-y-12">
                    {/* Main English Text */}
                    <div>
                        <div className="text-3xl md:text-6xl lg:text-[80px] font-display font-medium text-white leading-tight md:leading-[1.1] inline-block text-pretty">
                    ...
                    <div className="max-w-2xl">
                        <div className="text-base md:text-xl font-sans text-white/60 leading-relaxed flex items-start gap-2 whitespace-normal md:whitespace-nowrap">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-16 md:pt-24">
                        {/* Item 1 */}
                        <div className="space-y-4">
                            <h3 className="text-2xl md:text-[32px] font-bold text-white leading-tight">
                                문제를 발견하고<br />목표를 먼저 제안
                            </h3>
                            <p className="text-base md:text-[20px] text-white/60 leading-relaxed break-keep">
